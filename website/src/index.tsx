    ...
    (
        <div>
                    ...
                    <div className="collapse navbar-collapse">
                        <ul className="nav navbar-nav navbar-left">
                            <li className="navbar-header">
                                <a href="#"><img src="images/codacy-white.svg" alt="logo" /></a>
                            </li>
                            ...
                            <li className="dropdown project-name">
                                <select
                                    className="selectpicker select2-selected"
                                    data-live-search="true"
                                    data-live-search-placeholder="Project name..."
                                >
                                    <option selected data-tokens="My Projects">My Projects</option>
                                    <option data-tokens="Rodrigo Fernandes">Rodrigo Fernandes</option>
                                    <option data-tokens="Rafael Cortes">Rafael Cortes</option>
                                    <option data-divider="true">divider</option>
                                    <option data-tokens=" " data-icon="fa-plus">
                                ...
                                <ul className="dropdown-menu">
                                    ...
                                    <li>
                                        <form action="/logout" method="POST" id="logoutForm">
                                            ...
                                            {/* 
                                            // @ts-ignore */}
                                            <a id="signout-form" href="#" onclick=" logoutForm.submit();">
            ...
            <div className="container">
                <div className="row">
                    <aside>
                        <div className="col-md-3 border-secondary-right">
                            <div className="list-group side-menu">
                                <a
                                    href="/css-guidelines.html"
                                    className="list-group-item list-group-item-action"
                                >CSS/SASS guidelines</a
                                >
                                <a
                                    href="/css-guidelines.html"
                                    className="list-group-item list-group-item-action"
                                ...
                                <a
                                    className="list-group-item has-submenu"
                                    data-remote="true"
                                    href="#collapse-list-group-submenu"
                                    data-toggle="collapse"
                                    data-parent="#collapse-list-group-submenu"
                                >Components</a
                                >
                                <div
                                    className="collapse list-group-submenu"
                                    id="collapse-list-group-submenu"
                                >
                                    <a href="#colors" className="list-group-item sub-item"
                                    >Colour palette</a
                                    >
                                    <a href="#typo" className="list-group-item sub-item"
                                    >Typography</a
                                    >
                                    <a href="#buttons" className="list-group-item sub-item"
                                    >Buttons</a
                                    >
                                    <a href="#forms" className="list-group-item sub-item">Forms</a>
                                    <a href="#alerts" className="list-group-item sub-item">Alerts</a>
                                    <a href="#panels" className="list-group-item sub-item">Panels</a>
                                    <a href="#progress-bar" className="list-group-item sub-item"
                                    >Progress Bars</a
                                    >
                                    <a href="#tables" className="list-group-item sub-item">Tables</a>
                                    <a href="#deltas" className="list-group-item sub-item">Deltas</a>
                                    <a href="#navbar" className="list-group-item sub-item"
                                    >Navigation</a
                                    >
                                    <a href="#pagination" className="list-group-item sub-item"
                                    >Pagination</a
                                    >
                                </div>
                            </div>
                        ...
                        <div className="col-md-9">
                            ...
                            <section id="typo">
                                ...
                                the tag <code>&lt;small&gt;</code>.
                                    ...
                                    <abbr title="attribute" className="sg-code"
                                                            >attr.</abbr
                                                            >
                                                        </p>
                                                    </div>
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        ...
                                        <p>
                                            ...
                                            make, therefore, there should be
                            <strong>one primary button per page.</strong><br />
                                            <code>.btn-default</code> and <code>.btn-link</code> are the
                                            only buttons that can repeatedly appear in a page and
                            <strong
                                            >should not be used for primary or breaking actions.</strong
                                            >
                                            ...
                                            <div className="panel-body">
                                                <div className="row">
                                                    <div className="col-xs-6">
                                                        ...
                                                        <button
                                                            className="btn btn-default sg-code"
                                                            type="submit"
                                                        >
                                                            Default
                                    </button>
                                                        <button
                                                            className="btn btn-primary sg-code"
                                                            type="submit"
                                                        >
                                                            Primary
                                    </button>
                                                        <button className="btn btn-link sg-code" type="submit">
                                                            Link
                                    </button>
                                                        <button
                                                            className="btn btn-success sg-code"
                                                            type="submit"
                                                        >
                                                            Success
                                    </button>
                                                        <button
                                                            className="btn btn-danger sg-code"
                                                            type="submit"
                                                        >
                                                            Danger
                                    </button>
                                                    ...
                                                    <div className="col-xs-6">
                                                        <button
                                                            className="btn btn-default disabled sg-code"
                                                            type="submit"
                                                        >
                                                            Default disabled
                                    </button>
                                                        <button
                                                            className="btn btn-primary disabled sg-code"
                                                            type="submit"
                                                        >
                                                            Primary disabled
                                    </button>
                                                        <button
                                                            className="btn btn-link disabled sg-code"
                                                            type="submit"
                                                        >
                                                            Link disabled
                                    </button>
                                                        <button
                                                            className="btn btn-success disabled sg-code"
                                                            type="submit"
                                                        >
                                                            Success disabled
                                    </button>
                                                        <button
                                                            className="btn btn-danger disabled sg-code"
                                                            type="submit"
                                                        >
                                                            Danger disabled
                                    </button>
                                ...
                                <code>.btn-xs</code> to the button class.
                                </p>
                                                ...
                                                <h2>Button groups</h2>
                                                <div className="btn-group sg-code" role="group">
                                                ...
                                                <h2>Split buttons</h2>
                                                <div className="btn-group sg-code">
                                                    <button type="button" className="btn btn-default">
                                                        I'm an action
                                </button>
                                                    <button
                                                    ...
                                                    <ul className="dropdown-menu">
                                                        ...
                                                        <li><a href="#">A different one</a></li>
                            ...
                            <strong
                                ...
                                normal state when it becomes active.</strong
                                    ...
                                    <i
                                                ...
                                                <form>
                                                    <div className="form-group optional col-md-6 sg-code">
                                                        {/*
                                                        // @ts-ignore */}
                                                ...
                                                <form>
                                                    ...
                                                    >
                                                        <div className="checkbox">
                                                            ...
                                                            {/*
                                                            // @ts-ignore */}
                                                            <label for="checkbox54">Big</label>
                                                        </div>
                                                ...
                                                <form className="form-group col-md-6 sg-code">
                                                    ...
                                                    <div className="input-group">
                                                        <div className="input-group-addon checkbox checkbox-lg">
                                                            ...
                                                            {/*
                                                            // @ts-ignore */}
                                                            <label for="addon-checkbox"></label>
                                                        </div>
                                                        <input
                                                            type="text"
                                                            className="form-control"
                                                        ...
                                                        <div className="dropdown sg-code">
                                                            ...
                                                            <ul className="dropdown-menu">
                                                                <li>
                                                                    {/*
                                                                    // @ts-ignore */}
                                                                    <a tabindex="-1" href="#">HTML</a></li>
                                                                <li>
                                                                    {/*
                                                                    // @ts-ignore */}
                                                                    <a tabindex="-1" href="#">CSS</a></li>
                                                    ...
                                                    <div className="dropdown pull-left">
                                                        ...
                                                        <ul className="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <li className="dropdown-submenu pull-left">
                                                                {/*
                                                                // @ts-ignore */}
                                                                <a className="test" tabindex="-1" href="#">New dropdown</a>
                                                                <ul className="dropdown-menu">
                                                                    <li>
                                                                        {/*
                                                                        // @ts-ignore */}
                                                                    ...
                                                                    <li>
                                                                        {/*
                                                                        // @ts-ignore */}
                                                                        <a tabindex="-1" href="#">2nd level dropdown second</a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                        </ul>
                                        ...
                                        <div className="panel">
                                            <div className="panel-body">
                                                <div className="checkbox checkbox-md">
                                                    ...
                                                    {/*
                                                    // @ts-ignore */}
                                                    <label for="checkbox12">Big</label>
                                                </div>
                                ...
                                <code>.checkbox-inline</code> to the parent. <br />
                                                ...
                                                <div className="switch-container switch-md">
                                                    ...
                                                    {/*
                                                    // @ts-ignore */}
                                                    <label className="switch-label" for="switch2"></label>
                                                </div>
                                                <div className="switch-container sg-code">
                                                    ...
                                                    {/*
                                                    // @ts-ignore */}
                                                    <label className="switch-label" for="switch1"></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <section id="progress-bar">
                                <div className="row">
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <div className="progress progress-sm sg-code">
                                            {/*
                                            // @ts-ignore */}
                                            <div
